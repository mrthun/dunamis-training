...
#== Route Map
# Generated on 28 Jul 2011 18:59
#
...
# delete_organization_organizations GET    /organizations/delete_organization(.:format) {:action=>"delete_organization", :controller=>"organizations"}
...
#       remove_location_registrants GET    /registrants/remove_location(.:format)       {:action=>"remove_location", :controller=>"registrants"}
...
#           remove_location_clients GET    /clients/remove_location(.:format)           {:action=>"remove_location", :controller=>"clients"}
...
#           create_location_clients POST   /clients/create_location(.:format)           {:action=>"create_location", :controller=>"clients"}
...
#                   list_timesheets GET    /timesheets/list(.:format)                   {:action=>"list", :controller=>"timesheets"}
#                details_timesheets GET    /timesheets/details(.:format)                {:action=>"details", :controller=>"timesheets"}
#                 delete_timesheets GET    /timesheets/delete(.:format)                 {:action=>"delete", :controller=>"timesheets"}
#                        timesheets POST   /timesheets(.:format)                        {:action=>"create", :controller=>"timesheets"}
#                    new_timesheets GET    /timesheets/new(.:format)                    {:action=>"new", :controller=>"timesheets"}
#                   edit_timesheets GET    /timesheets/edit(.:format)                   {:action=>"edit", :controller=>"timesheets"}
#                                   GET    /timesheets(.:format)                        {:action=>"show", :controller=>"timesheets"}
#                                   PUT    /timesheets(.:format)                        {:action=>"update", :controller=>"timesheets"}
#                                   DELETE /timesheets(.:format)                        {:action=>"destroy", :controller=>"timesheets"}
#                              root        /(.:format)                                  {:action=>"index", :controller=>"home"}
#                                          /*a                                          {:action=>"routing", :controller=>"home"}
